...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orlen.Core.Entities.Bus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Orlen.Core.Entities.BusStop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Orlen.Core.Entities.BusStop", b =>
                {
                    b.HasOne("Orlen.Core.Entities.Bus", "Bus")
                        .WithMany("Stops")
                        .HasForeignKey("BusId")
                        .OnDelete(DeleteBehavior.Cascade);
